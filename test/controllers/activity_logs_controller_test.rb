...
class ActivityLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create activity_log" do
    assert_difference('ActivityLog.count') do
      post activity_logs_url, params: { activity_log: { activity: @activity_log.activity, ended_at: @activity_log.ended_at, started_at: @activity_log.started_at } }
    end
  ...
  test "should update activity_log" do
    patch activity_log_url(@activity_log), params: { activity_log: { activity: @activity_log.activity, ended_at: @activity_log.ended_at, started_at: @activity_log.started_at } }
